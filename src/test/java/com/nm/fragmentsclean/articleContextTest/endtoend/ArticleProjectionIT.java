...
public class ArticleProjectionIT extends AbstractBaseE2E {
	...
	void creating_article_populates_articles_projection_via_outbox_and_eventbus() throws Exception {
		...
		List<Map<String, Object>> rows = jdbcTemplate.queryForList("SELECT * FROM articles_projection");
		...
		// tu peux aussi vérifier blocks_json / cover_json / tags_json si tu veux aller
		// plus loin
	}
}
