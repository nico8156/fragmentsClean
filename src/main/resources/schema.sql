...
ALTER TABLE inbox_messages ADD COLUMN IF NOT EXISTS lease_owner VARCHAR(36);
...
-- Durable per-context tombstones prevent delayed integration events from recreating erased data.
