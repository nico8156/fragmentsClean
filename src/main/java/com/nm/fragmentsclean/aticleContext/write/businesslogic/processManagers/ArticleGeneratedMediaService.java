...
import com.nm.fragmentsclean.aticleContext.write.businesslogic.gateways.*;
...
public final class ArticleGeneratedMediaService {
    ...
    private ArticleImageRef generateOne(UUID sagaId,UUID articleId,String slot,ArticleImageGenerationProvider.Role role,com.nm.fragmentsclean.aticleContext.write.businesslogic.models.generation.ArticleVisualBrief brief,String consistency,String alt){
