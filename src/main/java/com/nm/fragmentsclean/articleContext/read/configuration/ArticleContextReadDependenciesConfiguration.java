package com.nm.fragmentsclean.articleContext.read.configuration;
...
@Configuration
@EntityScan(basePackages = "com.nm.fragmentsclean.articleContext.write.adapters.secondary.gateways.repositorie.jpa.entities")
@EnableJpaRepositories(basePackages = "com.nm.fragmentsclean.articleContext.write.adapters.secondary.gateways.repositorie.jpa")
