package com.nm.fragmentsclean.articleContext.write.adapters.primary.springboot.sqs;
...
import com.nm.fragmentsclean.articleContext.write.businesslogic.processManagers.ArticleGenerationCompletionHandler;
import com.nm.fragmentsclean.articleContext.write.businesslogic.processManagers.ArticleGenerationLeaseClaimer;
...
public final class ArticleGenerationRequestedSqsIntegrationEventHandler implements SqsIntegrationEventHandler {
    ...
    private final com.nm.fragmentsclean.articleContext.write.businesslogic.processManagers.ArticleGeneratedMediaService media;
    ...
    public ArticleGenerationRequestedSqsIntegrationEventHandler(SqsIntegrationEventPayloadReader payloadReader,
            ArticleGenerationLeaseClaimer claimer, ArticleGenerationProvider provider, com.nm.fragmentsclean.articleContext.write.businesslogic.processManagers.ArticleGeneratedMediaService media, ArticleGenerationCompletionHandler completer, ArticleAuthoringObservability observability) {
