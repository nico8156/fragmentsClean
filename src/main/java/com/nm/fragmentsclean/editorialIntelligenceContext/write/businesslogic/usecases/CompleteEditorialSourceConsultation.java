...
@Component public final class CompleteEditorialSourceConsultation {
 ...
 @Transactional public int execute(UUID sourceId,String workerId,List<SourceSignal> discovered,String etag,String lastExternalId,Instant lastPublishedAt){
  ...
  source.completeConsultation(workerId,count,etag,lastExternalId,lastPublishedAt,clock.now()); sources.save(source); return count;
 }
}
