...
public final class ListBlockedUsersQueryHandler {
    ...
    public ListBlockedUsersQueryHandler(JdbcTemplate jdbc) { this.jdbc = jdbc; }
    public List<BlockedUserView> handle(UUID requesterId) {
        return jdbc.query("""
            ...
            """, (rs, row) -> new BlockedUserView(rs.getObject("block_id", UUID.class),
                ...
                rs.getString("avatar_url"), rs.getTimestamp("updated_at").toInstant(), rs.getLong("version")), requesterId);
    }
}
