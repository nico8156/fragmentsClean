...
public record UpdateExperienceCommand(UUID commandId, UUID experienceId, UUID userId,
                                      String message, Instant clientAt) implements AuthenticatedCommand {
    @Override public UUID receiptCommandId() { return commandId; }
    @Override public UUID requesterId() { return userId; }
    @Override public String receiptType() { return "experience.update.v1"; }
}
