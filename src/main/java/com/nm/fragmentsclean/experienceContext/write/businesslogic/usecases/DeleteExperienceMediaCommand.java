...
public record DeleteExperienceMediaCommand(UUID commandId, UUID experienceId, UUID mediaId,
    UUID userId, Instant clientAt) implements AuthenticatedCommand {
  @Override public UUID receiptCommandId() { return commandId; }
  @Override public UUID requesterId() { return userId; }
  @Override public String receiptType() { return "experience.media.delete.v1"; }
}
