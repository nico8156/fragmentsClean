...
public class ExperienceSqsIntegrationEventHandlers{
    ...
    @Bean SqsIntegrationEventHandler experienceMediaChanged(ExperienceProjectionEventHandler handler){return route("experience.media.changed",e->handler.handle(reader.read(e,ExperienceIntegrationEvents.MediaChanged.class)));}
