...
public final class AdminEditorialSourcesController {
 private final ManageEditorialSource manage; private final EditorialSourceStudioCatalog catalog;
 public AdminEditorialSourcesController(ManageEditorialSource manage, EditorialSourceStudioCatalog catalog){this.manage=manage;this.catalog=catalog;}
